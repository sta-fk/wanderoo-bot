...
class DefaultCurrencyViewDataBuilder implements ViewDataBuilderInterface
{
    ...
    public function buildNextViewDataCollection(TelegramUpdate $update): ViewDataCollection
    {
        ...
        return ViewDataCollection::createWithSingleViewData(new DefaultCurrencyViewData($chatId));
    }
}
